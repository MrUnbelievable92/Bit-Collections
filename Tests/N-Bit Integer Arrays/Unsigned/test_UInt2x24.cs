...
{
    internal static class _UInt2x24
    {
        internal static UInt2x24 TestData_LHS => new UInt2x24(UInt2.MaxValue, 1, 2, 0, 0, 1, 3, 0, 3, 3, 1, 0, 2, 3, 1, 2, 3, 3, 3, 0, 2, 1, 2, 0);
        internal static UInt2x24 TestData_RHS => new UInt2x24(UInt2.MinValue, 1, 3, 3, 2, 1, 0, 2, 0, 3, 2, 2, 1, 3, 0, 2, 2, 1, 1, 1, 0, 2, 3, 0);
        
        private static UInt2x24 Random(byte min = 0, byte max = 0)
        {
            Random8 rng = Random8.New;

            UInt2x24 test = new UInt2x24();
            for (int i = 0; i < 24; i++)
            {
        ...
        [Test]
        public static void Constructor_uintx24()
        {
            bool result = true;

            UInt2x24 test = new UInt2x24(1, 0, 0, 2, 3, 1, 0, 2, 3, 1, 2, 0, 1, 0, 3, 2, 3, 0, 1, 2, 2, 1, 0, 3);
