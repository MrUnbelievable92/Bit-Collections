...
namespace BitCollections.Tests
{
    internal static class _UInt2x4
    {
        ...
        private static UInt2x4 Random(byte min = 0, byte max = 0)
        {
            Random8 rng = Random8.New;

            UInt2x4 test = new UInt2x4();
            for (int i = 0; i < 4; i++)
            {
