...
{
    internal static class _UInt12x4
    {
        internal static UInt12x4 TestData_LHS => new UInt12x4(UInt12.MaxValue, 17, 47, 3000);
        internal static UInt12x4 TestData_RHS => new UInt12x4(UInt12.MinValue, 4000, 999, 192);

        private static UInt12x4 Random(ushort min = 0, ushort max = 0)
        {
            Random16 rng = Random16.New;

            UInt12x4 test = new UInt12x4();
            for (int i = 0; i < 4; i++)
            {
                test[i] = rng.NextUShort(min != 0 ? min : UInt12.MinValue, max != 0 ? max : (ushort)(UInt12.MaxValue + 1));
            }
        ...
        public static void Constructor_uint()
        {
            ...
            UInt12x4 test = new UInt12x4(1747);
            result &= test.x == 1747;
            result &= test.y == 1747;
            result &= test.z == 1747;
            result &= test.w == 1747;
        ...
        public static void Constructor_uintx2()
        {
            ...
            UInt12x4 test = new UInt12x4(17, 47, 21, 3333);
        ...
        public static void GetSingle()
        {
            ...
            result &= TestData_LHS[3] == 3000;

            result &= TestData_RHS[0] == UInt12.MinValue;
            result &= TestData_RHS[1] == 4000;
        ...
        {
            UInt12x4 test = Random(0, byte.MaxValue + 1);
        ...
        {
            UInt12x4 test = Random(0, sbyte.MaxValue + 1);
        ...
        {
            UInt12x4 test = Random(0, (byte)(quarter.MaxValue + 1));
        ...
        public static void AddVectorVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(add[j], (l[j] + r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void AddVectorScalar()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(add[j], (l[j] + r) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void AddScalarVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(add[j], (l + r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void SubVectorVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(sub[j], (l[j] - r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void SubVectorScalar()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(sub[j], (l[j] - r) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void SubScalarVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(sub[j], (l - r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void MulVectorVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(mul[j], (l[j] * r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void MulVectorScalar()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(mul[j], (l[j] * r) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void MulScalarVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(mul[j], (l * r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void DivVectorVector()
        {
            ...
            {
                UInt12x4 l = Random();
                UInt12x4 r = Random(min: 1);
                UInt12x4 div = l / r;

                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(div[j], (l[j] / r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void DivVectorScalar()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(div[j], (l[j] / r) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void DivScalarVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(div[j], (l / r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void ModVectorVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(mod[j], (l[j] % r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void ModVectorScalar()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(mod[j], (l[j] % r) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void ModScalarVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(mod[j], (l % r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void AndVectorVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(and[j], (l[j] & r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void AndVectorScalar()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(and[j], (l[j] & r) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void AndScalarVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(and[j], (l & r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void OrVectorVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(or[j], (l[j] | r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void OrVectorScalar()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(or[j], (l[j] | r) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void OrScalarVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(or[j], (l | r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void XorVectorVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(xor[j], (l[j] ^ r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void XorVectorScalar()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(xor[j], (l[j] ^ r) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void XorScalarVector()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(xor[j], (l ^ r[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void Not()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(not[j], (~x[j]) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void ShiftLeft()
        {
            for (int i = 0; i < 124; i++)
            {
                ...
                UInt12x4 shiftLeft = x << n;

                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(shiftLeft[j], (x[j] << n) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
        ...
        public static void ShiftRight()
        {
            for (int i = 0; i < 124; i++)
            {
                UInt12x4 x = Random();
                int n = (int)RandomUInt(0, default(UInt12).Bits);
                UInt12x4 shiftRight = x >> n;

                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(shiftRight[j], (x[j] >> n) & math.bitmask32((uint)default(UInt12).Bits));
                }
            }
        }
    }
