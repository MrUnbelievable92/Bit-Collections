...
namespace BitCollections.Tests
{
    internal static class _UInt3x8
    {
        ...
        private static UInt3x8 Random(byte min = 0, byte max = 0)
        {
            Random8 rng = Random8.New;

            UInt3x8 test = new UInt3x8();
            for (int i = 0; i < 8; i++)
            {
