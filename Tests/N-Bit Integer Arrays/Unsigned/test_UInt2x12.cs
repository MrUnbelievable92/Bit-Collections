...
{
    internal static class _UInt2x12
    {
        internal static UInt2x12 TestData_LHS => new UInt2x12(UInt2.MaxValue, 1, 2, 0, 0, 1, 3, 0, 3, 3, 1, 0);
        internal static UInt2x12 TestData_RHS => new UInt2x12(UInt2.MinValue, 1, 3, 3, 2, 1, 0, 2, 0, 3, 2, 2);
        
        private static UInt2x12 Random(byte min = 0, byte max = 0)
        {
            Random8 rng = Random8.New;

            UInt2x12 test = new UInt2x12();
            for (int i = 0; i < 12; i++)
            {
        ...
        private static UInt2x12 Random()
        {
            Random8 rng = Random8.New;
            ...
            for (int i = 0; i < 12; i++)
            {
                test[i] = rng.NextByte(UInt2.MinValue, UInt2.MaxValue + 1);
            }
        ...
        public static void Constructor_uintx16()
        {
            ...
            UInt2x12 test = new UInt2x12(1, 0, 0, 2, 3, 1, 0, 2, 3, 1, 2, 0);
        ...
        {
            UInt2x12 test = Random();
            UInt4x12 byte2test = test;
        ...
        public static void AddVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(add[j], (l[j] + r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void AddVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(add[j], (l[j] + r) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void AddScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(add[j], (l + r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void SubVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(sub[j], (l[j] - r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void SubVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(sub[j], (l[j] - r) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void SubScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(sub[j], (l - r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void MulVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(mul[j], (l[j] * r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void MulVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(mul[j], (l[j] * r) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void MulScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(mul[j], (l * r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void DivVectorVector()
        {
            ...
            {
                UInt2x12 l = Random();
                UInt2x12 r = Random(min: 1);
                UInt2x12 div = l / r;

                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(div[j], (l[j] / r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void DivVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(div[j], (l[j] / r) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void DivScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(div[j], (l / r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void ModVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(mod[j], (l[j] % r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void ModVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(mod[j], (l[j] % r) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void ModScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(mod[j], (l % r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void AndVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(and[j], (l[j] & r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void AndVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(and[j], (l[j] & r) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void AndScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(and[j], (l & r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void OrVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(or[j], (l[j] | r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void OrVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(or[j], (l[j] | r) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void OrScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(or[j], (l | r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void XorVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(xor[j], (l[j] ^ r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void XorVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(xor[j], (l[j] ^ r) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void XorScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(xor[j], (l ^ r[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void Not()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(not[j], (~x[j]) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void ShiftLeft()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                UInt2x12 shiftLeft = x << n;

                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(shiftLeft[j], (x[j] << n) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
        ...
        public static void ShiftRight()
        {
            for (int i = 0; i < 64; i++)
            {
                UInt2x12 x = Random();
                int n = (int)RandomUInt(0, default(UInt2).Bits);
                UInt2x12 shiftRight = x >> n;

                for (int j = 0; j < 12; j++)
                {
                    Assert.AreEqual(shiftRight[j], (x[j] >> n) & math.bitmask32((uint)default(UInt2).Bits));
                }
            }
        }
    }
