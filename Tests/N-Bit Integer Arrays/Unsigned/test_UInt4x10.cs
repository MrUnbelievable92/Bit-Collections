...
namespace BitCollections.Tests
{
    internal static class _UInt4x10
    {
        ...
        private static UInt4x10 Random(byte min = 0, byte max = 0)
        {
            Random8 rng = Random8.New;

            UInt4x10 test = new UInt4x10();
            for (int i = 0; i < 10; i++)
            {
