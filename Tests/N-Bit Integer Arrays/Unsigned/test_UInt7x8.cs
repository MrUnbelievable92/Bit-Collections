    ...
    internal static class _UInt7x8
    {
        ...
        public static void AddVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(add[j], (l[j] + r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void AddVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(add[j], (l[j] + r) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void AddScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(add[j], (l + r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void SubVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(sub[j], (l[j] - r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void SubVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(sub[j], (l[j] - r) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void SubScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(sub[j], (l - r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void MulVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(mul[j], (l[j] * r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void MulVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(mul[j], (l[j] * r) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void MulScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(mul[j], (l * r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void DivVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(div[j], (l[j] / r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void DivVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(div[j], (l[j] / r) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void DivScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(div[j], (l / r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void ModVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(mod[j], (l[j] % r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void ModVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(mod[j], (l[j] % r) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void ModScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(mod[j], (l % r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void AndVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(and[j], (l[j] & r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void AndVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(and[j], (l[j] & r) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void AndScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(and[j], (l & r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void OrVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(or[j], (l[j] | r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void OrVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(or[j], (l[j] | r) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void OrScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(or[j], (l | r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void XorVectorVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(xor[j], (l[j] ^ r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void XorVectorScalar()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(xor[j], (l[j] ^ r) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void XorScalarVector()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(xor[j], (l ^ r[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void Not()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(not[j], (~x[j]) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void ShiftLeft()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(shiftLeft[j], (x[j] << n) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
        ...
        public static void ShiftRight()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    Assert.AreEqual(shiftRight[j], (x[j] >> n) & math.bitmask32((uint)default(UInt7).Bits));
                }
            }
        }
    }
