...
{
    internal static class _UInt4x14
    {
        internal static UInt4x14 TestData_LHS => new UInt4x14(UInt4.MaxValue, 1, 7, 11, 4, 12, 3, 2, 15, 3, 1, 9, 0, 3);
        internal static UInt4x14 TestData_RHS => new UInt4x14(UInt4.MinValue, 1, 13, 3, 2, 14, 0, 15, 10, 6, 2, 9, 1, 7);

        
        private static UInt4x14 Random(byte min = 0, byte max = 0)
        {
            Random8 rng = Random8.New;

            UInt4x14 test = new UInt4x14();
            for (int i = 0; i < 14; i++)
            {
        ...
        [Test]
        public static void Constructor_uintx14()
        {
            bool result = true;

            UInt4x14 test = new UInt4x14(1, 7, 10, 12, 6, 11, 15, 2, 8, 1, 14, 0, 7, 9);
