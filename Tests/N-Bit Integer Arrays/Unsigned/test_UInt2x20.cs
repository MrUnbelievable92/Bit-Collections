...
namespace BitCollections.Tests
{
    internal static class _UInt2x20
    {
        ...
        private static UInt2x20 Random(byte min = 0, byte max = 0)
        {
            Random8 rng = Random8.New;

            UInt2x20 test = new UInt2x20();
            for (int i = 0; i < 20; i++)
            {
