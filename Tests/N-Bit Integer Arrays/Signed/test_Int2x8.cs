...
namespace BitCollections.Tests
{
    internal static class _Int2x8
    {
        ...
        private static Int2x8 Random(sbyte min = Int2.MinValue, sbyte max = Int2.MaxValue + 1)
        {
            Random8 rng = Random8.New;

            Int2x8 test = new Int2x8();
            for (int i = 0; i < 8; i++)
            {
        ...
        [Test]
        public static void ToFromInt3x8()
        {
            Int2x8 test = Random();
            Int3x8 byte8test = (Int3x8)test;
        ...
        [Test]
        public static void ToFromUInt3x8()
        {
            Int2x8 test = Random(0);
            UInt3x8 byte8test = (UInt3x8)test;

            for (int i = 0; i < 8; i++)
            {
                Assert.AreEqual(((UInt3x8)((Int3x8)test))[i], byte8test[i]);
            }
