...
namespace BitCollections.Tests
{
    internal static class _Int4x14
    {
        ...
        private static Int4x14 Random(sbyte min = Int4.MinValue, sbyte max = Int4.MaxValue + 1)
        {
            Random8 rng = Random8.New;

            Int4x14 test = new Int4x14();
            for (int i = 0; i < 14; i++)
            {
