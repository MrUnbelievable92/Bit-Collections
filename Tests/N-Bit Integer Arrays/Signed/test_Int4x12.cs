...
namespace BitCollections.Tests
{
    internal static class _Int4x12
    {
        ...
        private static Int4x12 Random(sbyte min = Int4.MinValue, sbyte max = Int4.MaxValue + 1)
        {
            Random8 rng = Random8.New;

            Int4x12 test = new Int4x12();
            for (int i = 0; i < 12; i++)
            {
