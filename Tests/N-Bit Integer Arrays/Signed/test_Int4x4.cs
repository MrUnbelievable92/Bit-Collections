...
namespace BitCollections.Tests
{
    internal static class _Int4x4
    {
        ...
        private static Int4x4 Random(sbyte min = Int4.MinValue, sbyte max = Int4.MaxValue + 1)
        {
            Random8 rng = Random8.New;

            Int4x4 test = new Int4x4();
            for (int i = 0; i < 4; i++)
            {
