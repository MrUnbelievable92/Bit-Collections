...
namespace BitCollections.Tests
{
    internal static class _Int4x10
    {
        ...
        private static Int4x10 Random(sbyte min = Int4.MinValue, sbyte max = Int4.MaxValue + 1)
        {
            Random8 rng = Random8.New;

            Int4x10 test = new Int4x10();
            for (int i = 0; i < 10; i++)
            {
