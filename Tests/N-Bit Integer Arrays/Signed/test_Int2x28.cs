...
namespace BitCollections.Tests
{
    internal static class _Int2x28
    {
        ...
        private static Int2x28 Random(sbyte min = Int2.MinValue, sbyte max = Int2.MaxValue + 1)
        {
            Random8 rng = Random8.New;

            Int2x28 test = new Int2x28();
            for (int i = 0; i < 28; i++)
            {
