...
{
    internal static class _Int4x12
    {
        internal static Int4x12 TestData_LHS => new Int4x12(Int4.MaxValue, 1, 7, -1, 4, -2, 3, 2, -5, 3, 1, -6);
        internal static Int4x12 TestData_RHS => new Int4x12(Int4.MinValue, 1, -3, 3, 2, -4, 0, -5, -1, 6, 2, -6);
        ...
        public static void Constructor_intx12()
        {
            ...
            Int4x12 test = new Int4x12(1, 7, -1, -2, 6, -1, -5, 2, -8, 1, -4, 0);
        ...
        public static void Constructor_int8x2()
        {
            ...
            int4 valueHi = new int4(-2, 7, -5, -1);

            Int4x12 test = new Int4x12(valueLo, valueHi);
