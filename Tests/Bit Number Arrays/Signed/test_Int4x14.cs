...
{
    internal static class _Int4x14
    {
        internal static Int4x14 TestData_LHS => new Int4x14(Int4.MaxValue, 1, 7, -1, 4, -2, 3, 2, -5, 3, 1, -6, 0, 3);
        internal static Int4x14 TestData_RHS => new Int4x14(Int4.MinValue, 1, -3, 3, 2, -4, 0, -5, -1, 6, 2, -6, 1, 7);
        ...
        [Test]
        public static void Constructor_intx14()
        {
            bool result = true;

            Int4x14 test = new Int4x14(1, 7, -1, -2, 6, -1, -5, 2, -8, 1, -4, 0, 7, -6);
        ...
        public static void Constructor_int8x2()
        {
            ...
            int8 valueHi = new int8(-2, 7, -5, -1, 2, -1, 0, 0);

            Int4x14 test = new Int4x14(valueLo, valueHi);
