...
namespace BitCollections.Tests
{
    internal static class _UInt4x14
    {
        ...
        public static void Constructor_uint8x2()
        {
            ...
            uint8 valueHi = new uint8(12, 7, 15, 11, 2, 10, 0, 0);

            UInt4x14 test = new UInt4x14(valueLo, valueHi);
        ...
        public static void SetVector()
        {
            ...
            for (int i = 0; i < 11; i++)
            {
                ...
                result &= test[11] == ((i == 8)  ? vector.w : ((i == 9)  ? vector.z : ((i == 10) ? vector.y : TestData_LHS.x11)));
                result &= test[12] == ((i == 9)  ? vector.w : ((i == 10) ? vector.z : TestData_LHS.x12));
                result &= test[13] == ((i == 10) ? vector.w : TestData_LHS.x13);
            }
