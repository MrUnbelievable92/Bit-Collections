...
namespace BitCollections.Tests
{
    internal static class _UInt4x12
    {
        ...
        public static void Constructor_uint8x2()
        {
            ...
            uint4 valueHi = new uint4(12, 7, 15, 11);

            UInt4x12 test = new UInt4x12(valueLo, valueHi);
        ...
        public static void SetVector()
        {
            ...
            for (int i = 0; i < 9; i++)
            {
                ...
                result &= test[9]  == ((i == 6) ? vector.w : ((i == 7)  ? vector.z : ((i == 8)  ? vector.y : TestData_LHS.x9)));
                result &= test[10] == ((i == 7) ? vector.w : ((i == 8)  ? vector.z : TestData_LHS.x10));
                result &= test[11] == ((i == 8) ? vector.w : TestData_LHS.x11);
            }
