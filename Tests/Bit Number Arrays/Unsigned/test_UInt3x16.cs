...
namespace BitCollections.Tests
{
    internal static class _UInt3x16
    {
        ...
        public static void Constructor_uint8x2()
        {
            ...
            uint8 valueLo = new uint8(3, 7, 1, 6, 2, 0, 6, 1);
            uint8 valueHi = new uint8(2, 7, 5, 1, 2, 4, 4, 2);

            UInt3x16 test = new UInt3x16(valueLo, valueHi);
        ...
        {
            bool result = true;
            ulong4 vector = new ulong4(5, 1, 7, 0);
