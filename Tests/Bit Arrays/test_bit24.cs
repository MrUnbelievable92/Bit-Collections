...
{
    internal static class _bit24
    {
        internal static bit24 TestData_LHS => new bit24{ Bits = 0b1011_0001_1101_0010_0010_1011_1001_1110 };
        internal static bit24 TestData_RHS => new bit24{ Bits = 0b1101_0110_0001_1101_1011_0101_1101_1110 };

        private static Random32 rng = Random32.New;

        private static bit24 Random => new bit24 { Bits = rng.NextUInt() };
        private static bool RandomBool => rng.NextBool();
        private static int RandomIndex() => rng.NextInt(0, 24);
        private static int RandomNumBits(int index) => rng.NextInt(0, 24 - index + 1);

        private static void AssertBitsOutsideFieldAreUntouched(bit24 t0, bit24 t1, int idx, int num)
        {
            for (int j = 0; j < idx; j++)
            {
                Assert.AreEqual(t0[j], t1[j]);
            }
            for (int j = idx + num; j < 24; j++)
            {
                Assert.AreEqual(t0[j], t1[j]);
            }
        }
        ...
        public static void SetReplicate_BitField()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                bit24 t0 = Random;
                bit24 t1 = t0.SetReplicate(idx, num, b);
        ...
        public static void ResetFirst_BitField()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                int num = RandomNumBits(idx);
                bit24 t0 = Random;
                bit24 t1 = t0.ResetFirst(idx, num);
        ...
        public static void ShiftLeft()
        {
            for (int i = 0; i < 128; i++)
            {
                int n = RandomNumBits(0) % 24;
                bit24 t0 = Random;
                bit24 t1 = t0.ShiftLeft(n);
        ...
        public static void ShiftLeft_BitField()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                bit24 t0 = Random;
                bit24 t1 = t0.ShiftLeft(idx, num, n);
        ...
        public static void ShiftRight_BitField()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                int n = rng.NextInt(0, num + 1);
                bit24 t0 = Random;
                bit24 t1 = t0.ShiftRight(idx, num, n);
        ...
        public static void RotateLeft()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                bit24 t0 = Random;
                bit24 t1 = t0.RotateLeft(n);

                for (int j = 0; j < 24; j++)
                {
                    Assert.AreEqual(t0[(j - n + 24) % 24], t1[j]);
                }
            }
        }
        ...
        public static void RotateLeft_BitField()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                int n = rng.NextInt(0, num + 1);
                bit24 t0 = Random;
                bit24 t1 = num == 0 ? t0 : t0.RotateLeft(idx, num, n);
        ...
        public static void RotateRight_BitField()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                int n = rng.NextInt(0, num + 1);
                bit24 t0 = Random;
                bit24 t1 = num == 0 ? t0 : t0.RotateRight(idx, num, n);
        ...
        public static void Reverse()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                for (int j = 0; j < 24; j++)
                {
                    Assert.AreEqual(t0[(24 - 1) - j], t1[j]);
                }
            }
        }
        ...
        public static void Swap_BitField()
        {
            for (int i = 0; i < 128; i++)
            {
                int num = rng.NextInt(0, (24 / 2) + 1);
                int idx0 = rng.NextInt(0, 24 - 2 * num + tobyte(num != 0));
                int idx1 = rng.NextInt(idx0 + num, 24 - num + tobyte(num != 0));
                bit24 t0 = Random;
                bit24 t1 = t0.Swap(idx0, idx1, num);
        ...
        public static void IndexOfFirst_BitField()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                if (num == 0)
                {
                    Assert.IsFalse(isinrange(iof, 0, 23));
                    break;
                }
        ...
        public static void IndexOfLast_BitField()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                if (num == 0)
                {
                    Assert.IsFalse(isinrange(iol, 0, 23));
                    break;
                }
        ...
        private static int __countbits(bit24 t, int idx, int num)
        {
            int r = 0;
            for (int i = 0; i < num; i++)
            {
        ...
        public static void CountBits()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                Assert.AreEqual(t.CountBits(), __countbits(t, 0, 24));
            }
        }
        ...
        private static int __longeststring(bool value, bit24 t, int idx, int num)
        {
            if (num <= 0) 
            {
                return 0;
        ...
        public static void TestAll()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                Assert.AreEqual(t.TestAll(), __countbits(t, 0, 24) == 24);
            }
        }
        ...
        public static void TestAny()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                Assert.AreEqual(t.TestAny(), __countbits(t, 0, 24) != 0);
            }
        }
        ...
        public static void TestNone()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                Assert.AreEqual(t.TestNone(), __countbits(t, 0, 24) == 0);
            }
        }
        ...
        public static void TestNotAll()
        {
            for (int i = 0; i < 128; i++)
            {
                ...
                Assert.AreEqual(t.TestNotAll(), __countbits(t, 0, 24) != 32);
            }
        }
