...
These four containers have optimized algorithms as member methods that avoid reading out/writing values individually. Where appropriate, they use an optional `SIMDAlgorithms`' `Comparison` enum parameter for advanced algorithms:
