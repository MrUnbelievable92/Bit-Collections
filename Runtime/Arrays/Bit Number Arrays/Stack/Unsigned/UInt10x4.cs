...
//Assert.IsNotGreater(w, UInt10.MaxValue);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Unity.Mathematics.uint4(UInt10x4 input) => (uint4)input;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Unity.Mathematics.int4(UInt10x4 input) => (int4)input;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator UInt10x4(Unity.Mathematics.uint4 input) => (UInt10x4)(uint4)input;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator UInt10x4(Unity.Mathematics.int4 input) => (UInt10x4)(int4)input;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Unity.Mathematics.half4(UInt10x4 input) => (half4)input;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator float4(UInt10x4 input) => (float4)(int4)input;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Unity.Mathematics.float4(UInt10x4 input) => (float4)input;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double4(UInt10x4 input) => (double4)(int4)input;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Unity.Mathematics.double4(UInt10x4 input) => (double4)input;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator UInt10x4(Unity.Mathematics.half4 input) => (UInt10x4)(half4)input;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator UInt10x4(float4 input) => (UInt10x4)(int4)input;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator UInt10x4(Unity.Mathematics.float4 input) => (UInt10x4)(float4)input;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator UInt10x4(double4 input) => (UInt10x4)(int4)input;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator UInt10x4(Unity.Mathematics.double4 input) => (UInt10x4)(double4)input;
