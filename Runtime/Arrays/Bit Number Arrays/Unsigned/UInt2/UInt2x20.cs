...
Assert.IsNotGreater(x16_19.w, UInt2.MaxValue);
        ...
        public uint this[[AssumeRange(0, 19)] int index]
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            readonly get
            {
...
Assert.IsWithinArrayBounds(index, Length);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ulong4 GetSubArray([AssumeRange(0, 16)] int index)
        {
Assert.IsValidSubarray(index, 4, Length);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetSubArray([AssumeRange(0, 16)] int index, ulong4 value)
        {
Assert.IsValidSubarray(index, 4, Length);
