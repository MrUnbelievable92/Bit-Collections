...
{
    [Serializable]
    unsafe public struct UInt2x24 : IBitNumberArray<uint>, IEquatable<UInt2x24>
    {
        internal UInt48 intern;


        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt2x24(uint x0, uint x1, uint x2, uint x3, uint x4, uint x5, uint x6, uint x7, uint x8, uint x9, uint x10, uint x11, uint x12, uint x13, uint x14, uint x15, uint x16, uint x17, uint x18, uint x19, uint x20, uint x21, uint x22, uint x23) : this(new uint8(x0, x1, x2, x3, x4, x5, x6, x7), new uint8(x8, x9, x10, x11, x12, x13, x14, x15), new uint8(x16, x17, x18, x19, x20, x21, x22, x23))
        { }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt2x24(uint x0_23)
        {
            uint8 vector = x0_23;

            this = new UInt2x24(vector, vector, vector);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt2x24(uint8 x0_7, uint8 x8_15, uint8 x16_23)
        {
...
Assert.IsNotGreater(x16_23.x7, UInt2.MaxValue);
            ...
            intern = (UInt48)((ulong)maxmath.csum(maxmath.shl(x0_7, (uint)new UInt2x24().BitsPerNumber * new uint8(0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u))
                                                  |
                                                  maxmath.shl(x8_15, (uint)new UInt2x24().BitsPerNumber * new uint8(8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u)))
                              |
                              ((ulong)maxmath.csum(maxmath.shl(x16_23, (uint)new UInt2x24().BitsPerNumber * new uint8(0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u))) << (new UInt2x24().BitsPerNumber * 16)));
        }
        ...
        public uint this[[AssumeRange(0, 23)] int index]
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            readonly get
            {
...
Assert.IsWithinArrayBounds(index, Length);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ulong4 GetSubArray([AssumeRange(0, 20)] int index)
        {
Assert.IsValidSubarray(index, 4, Length);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetSubArray([AssumeRange(0, 20)] int index, ulong4 value)
        {
Assert.IsValidSubarray(index, 4, Length);
...
Assert.IsNotGreater(value.w, UInt2.MaxValue);
            ...
            fixed (void* ptr = &this)
            {
                intern = (UInt48)(maxmath.andnot(*(ulong*)ptr, (ulong)maxmath.bitmask64(4 * BitsPerNumber,   index * BitsPerNumber))
                                  |
