...
{
    [Serializable]
    unsafe public struct UInt4x12 : IBitNumberArray<uint>, IEquatable<UInt4x12>
    {
        internal UInt48 intern;


        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt4x12(uint x0, uint x1, uint x2, uint x3, uint x4, uint x5, uint x6, uint x7, uint x8, uint x9, uint x10, uint x11) : this(new uint8(x0, x1, x2, x3, x4, x5, x6, x7), new uint4(x8, x9, x10, x11))
        { }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt4x12(uint x0_11)
        {
            uint8 vector = x0_11;

            this = new UInt4x12(vector, vector.v4_0);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt4x12(uint8 x0_7, uint4 x8_11)
        {
...
Assert.IsNotGreater(x8_11.x, UInt4.MaxValue);
Assert.IsNotGreater(x8_11.y, UInt4.MaxValue);
Assert.IsNotGreater(x8_11.z, UInt4.MaxValue);
Assert.IsNotGreater(x8_11.w, UInt4.MaxValue);

            intern = (UInt48)((ulong)maxmath.csum(maxmath.shl(x0_7, (uint)new UInt4x12().BitsPerNumber * new uint8(0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u)))
                              |
                              ((ulong)math.csum(maxmath.shl(x8_11, (uint)new UInt4x12().BitsPerNumber * new uint4(0u, 1u, 2u, 3u))) << (new UInt4x12().BitsPerNumber * 8)));
        }
        ...
        public uint this[[AssumeRange(0, 11)] int index]
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            readonly get
            {
