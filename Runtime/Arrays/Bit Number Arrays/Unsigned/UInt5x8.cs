...
{
    [Serializable]
    unsafe public struct UInt5x8 : IBitNumberArray<uint>, IEquatable<UInt5x8>
    {
        internal UInt40 intern;


        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt5x8(uint x0, uint x1, uint x2, uint x3, uint x4, uint x5, uint x6, uint x7) : this(new ulong4(x0, x1, x2, x3), new ulong4(x4, x5, x6, x7))
        { }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt5x8(uint x0_7)
        {
            ulong4 vector = new ulong4(x0_7);

            this = new UInt5x8(vector, vector);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt5x8(ulong4 x0_3, ulong4 x4_7)
        {
Assert.IsNotGreater(x0_3.x, UInt5.MaxValue);
Assert.IsNotGreater(x0_3.y, UInt5.MaxValue);
Assert.IsNotGreater(x0_3.z, UInt5.MaxValue);
Assert.IsNotGreater(x0_3.w, UInt5.MaxValue);
Assert.IsNotGreater(x4_7.x, UInt5.MaxValue);
Assert.IsNotGreater(x4_7.y, UInt5.MaxValue);
Assert.IsNotGreater(x4_7.z, UInt5.MaxValue);
Assert.IsNotGreater(x4_7.w, UInt5.MaxValue);

            intern = (UInt40)(maxmath.csum(maxmath.shl(x0_3, (ulong)new UInt5x8().BitsPerNumber * new ulong4(0ul, 1ul, 2ul, 3ul)))
                              |
                              maxmath.csum(maxmath.shl(x4_7, (ulong)new UInt5x8().BitsPerNumber * new ulong4(4ul, 5ul, 6ul, 7ul))));
        }


        public readonly uint MinValue => UInt5.MinValue;
        public readonly uint MaxValue => UInt5.MaxValue;
        public readonly int Length => 8;
        public readonly int BitsPerNumber => 5;
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]  [return: AssumeRange((ulong)UInt5.MinValue, (ulong)UInt5.MaxValue)]
            readonly get
            {
...
Assert.IsNotGreater(value.w, MaxValue);
        ...
        {
Assert.IsNotGreater(value, UInt5.MaxValue);
Assert.IsValidSubarray(index, numNumbers, Length);
            ...
            if (Constant.IsConstantExpression(value))
            {
                ...
                else
                {
                    ...
                    ulong newValues = new UInt5x8(value).intern & mask;
