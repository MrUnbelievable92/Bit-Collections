...
Assert.IsBetween(x24_27.w,  Int2.MinValue, Int2.MaxValue);
            ...
            intern = (UInt56)((ulong)(uint)maxmath.csum(maxmath.shl(mask & x0_7, new Int2x28().BitsPerNumber * new int8(0, 1, 2, 3, 4, 5, 6, 7))
                                                       |
...
Assert.IsWithinArrayBounds(index, Length);
                ...
                {
                    return (int)(((long)(Int56)intern) >> (index * BitsPerNumber));
                }
                else
                {
...
Assert.IsValidSubarray(index, numNumbers, Length);
            ...
            if (Constant.IsConstantExpression(value))
            {
                ...
                else
                {
                    ...
                    ulong newValues = new Int2x28(value).intern & mask;
