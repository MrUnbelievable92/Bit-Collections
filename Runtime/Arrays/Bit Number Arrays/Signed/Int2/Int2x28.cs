...
Assert.IsBetween(x24_27.w,  Int2.MinValue, Int2.MaxValue);
        ...
        public int this[[AssumeRange(0, 27)] int index]
        {
...
Assert.IsWithinArrayBounds(index, Length);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public long4 GetSubArray([AssumeRange(0, 24)] int index)
        {
Assert.IsValidSubarray(index, 4, Length);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetSubArray([AssumeRange(0, 24)] int index, long4 value)
        {
Assert.IsValidSubarray(index, 4, Length);
