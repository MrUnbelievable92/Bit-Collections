...
Assert.IsBetween(x16_19.w, Int2.MinValue, Int2.MaxValue);
            ...
            intern = (UInt40)((ulong)(uint)maxmath.csum(maxmath.shl(mask & x0_7, new Int2x20().BitsPerNumber * new int8(0, 1, 2, 3, 4, 5, 6, 7))
                                                       |
...
Assert.IsBetween(value.w, MinValue, MaxValue);
            ...
            intern = (UInt40)(((long)maxmath.andnot(intern, (ulong)maxmath.bitmask64(4 * BitsPerNumber, index * BitsPerNumber))
                                     |
...
Assert.IsValidSubarray(index, numNumbers, Length);
            ...
            if (Constant.IsConstantExpression(value))
            {
                ...
                else
                {
                    ...
                    ulong newValues = new Int2x20(value).intern & mask;
