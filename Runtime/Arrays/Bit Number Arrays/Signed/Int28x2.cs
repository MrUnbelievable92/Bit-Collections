        ...
        public long2 xy
        {
            ...
            readonly get
            {
                fixed (void* ptr = &this)
                {
                    ...
                    long2 temp = maxmath.shl((long2)(*(long*)ptr), 64 - (BitsPerNumber * new long2(1, 2)));
...
Assert.IsWithinArrayBounds(index, Length);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]  [param: AssumeRange(Int28.MinValue, Int28.MaxValue)]
            set
            {
