...
Assert.IsBetween(x8_11.w, Int4.MinValue, Int4.MaxValue);
            ...
            intern = (Int48)((ulong)(uint)maxmath.csum(maxmath.shl(mask & x0_7, new Int4x12().BitsPerNumber * new int8(0, 1, 2, 3, 4, 5, 6, 7)))
                             |
...
Assert.IsWithinArrayBounds(index, Length);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public long4 GetSubArray([AssumeRange(0, 8)] int index)
        {
Assert.IsValidSubarray(index, 4, Length);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetSubArray([AssumeRange(0, 8)] int index, long4 value)
        {
Assert.IsValidSubarray(index, 4, Length);
