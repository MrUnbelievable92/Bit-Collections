        ...
        public int4 xyzw
        {
            ...
            readonly get
            {
                fixed (void* ptr = &this)
                {
                    ...
                    int4 temp = maxmath.shl((int4)(*(int*)ptr), 32 - (BitsPerNumber * new int4(1, 2, 3, 4)));
...
Assert.IsWithinArrayBounds(index, Length);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]  [param: AssumeRange(Int6.MinValue, Int6.MaxValue)]
            set
            {
