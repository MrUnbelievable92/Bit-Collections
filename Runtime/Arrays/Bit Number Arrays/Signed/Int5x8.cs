...
namespace BitCollections
{
    ...
    unsafe public struct Int5x8 : IBitNumberArray<int>, IEquatable<Int5x8>
    {
        ...
        public Int5x8(int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7) : this(new long4(x0, x1, x2, x3), new long4(x4, x5, x6, x7))
        { }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Int5x8(int x0_7)
        {
            long4 vector = new long4(x0_7);

            this = new Int5x8(vector, vector);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Int5x8(long4 x0_3, long4 x4_7)
        {
Assert.IsBetween(x0_3.x, Int5.MinValue, Int5.MaxValue);
Assert.IsBetween(x0_3.y, Int5.MinValue, Int5.MaxValue);
Assert.IsBetween(x0_3.z, Int5.MinValue, Int5.MaxValue);
Assert.IsBetween(x0_3.w, Int5.MinValue, Int5.MaxValue);
Assert.IsBetween(x4_7.x, Int5.MinValue, Int5.MaxValue);
Assert.IsBetween(x4_7.y, Int5.MinValue, Int5.MaxValue);
Assert.IsBetween(x4_7.z, Int5.MinValue, Int5.MaxValue);
Assert.IsBetween(x4_7.w, Int5.MinValue, Int5.MaxValue);
        ...
        public readonly int MinValue => Int5.MinValue;
        public readonly int MaxValue => Int5.MaxValue;
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]  [return: AssumeRange(Int5.MinValue, Int5.MaxValue)]
            readonly get
            {
Assert.IsWithinArrayBounds(index, Length);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]  [param: AssumeRange(Int5.MinValue, Int5.MaxValue)]
            set
            {
