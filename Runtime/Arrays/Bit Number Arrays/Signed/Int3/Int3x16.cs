...
Assert.IsBetween(x8_15.x7, Int3.MinValue, Int3.MaxValue);
            ...
            intern = (UInt48)((ulong)(uint)maxmath.csum(maxmath.shl(mask & x0_7, new Int3x16().BitsPerNumber * new int8(0, 1, 2, 3, 4, 5, 6, 7)))
                             |
...
Assert.IsBetween(value.w, MinValue, MaxValue);
            ...
            intern = (UInt48)((long)maxmath.andnot(intern, (ulong)maxmath.bitmask64(4 * BitsPerNumber, index * BitsPerNumber))
                                    |
...
Assert.IsValidSubarray(index, numNumbers, Length);
            ...
            if (Constant.IsConstantExpression(value))
            {
                ...
                else
                {
                    ...
                    ulong newValues = new Int3x16(value).intern & mask;
